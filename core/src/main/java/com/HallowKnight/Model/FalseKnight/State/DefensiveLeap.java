...
public class DefensiveLeap extends State{
    public DefensiveLeap(FalseKnight falseKnight) {
        super(falseKnight);
    ...
    public void enter() {
        ...
        if (falseKnight.getKnight().b2Body.getPosition().x>falseKnight.b2Body.getPosition().x){
            ...
            falseKnight.b2Body.applyLinearImpulse(new Vector2(
                -FalseKnight.DEFENSIVE_LEAP_LINEAR_IMPULSE.x
                , FalseKnight.DEFENSIVE_LEAP_LINEAR_IMPULSE.y
            )
